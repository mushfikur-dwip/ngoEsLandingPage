      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div
              className={`relative flex size-20 scale-100 items-center justify-center rounded-full bg-gradient-to-b from-primary/30 to-sidebar-primary-foreground shadow-md transition-all duration-200 ease-out group-hover:scale-[1.2]`}>
              <Play
