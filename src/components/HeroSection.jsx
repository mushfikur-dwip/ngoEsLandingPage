...
const HeroSection = () => {
    return (
        <>
            <div className='flex flex-col px-2 py-10 lg:pt-4 lg:py-20'>
                <div className='flex flex-col items-center text-center  pb-2 '>
                    <h1 className='text-[38px] text-white lg:text-7xl font-bold tracking-tight leading-10 lg:leading-19 px-10 lg:px-50'>SaaS Videos that <span className='text-[#EE2461]'> Educate, <br className='hidden lg:block' />  Engage, and Convert.</span></h1>
                </div>
